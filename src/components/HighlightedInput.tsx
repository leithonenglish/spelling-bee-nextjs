  ...
  ({ value, mainLetter, otherLetters, onChange, onKeyDown }, ref) => {
    ...
    return (
      <div className="relative" ref={ref}>
        <div className="absolute z-10 w-full top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          {!value ? (
            <span className="block w-full whitespace-nowrap text-3xl text-gray-400 text-center font-light">
              Type or click
            </span>
          ) : (
            <div className="flex items-center justify-center tracking-[-0.025em] overflow-hidden">
        ...
        <input
          ...
          type="text"
          value={value}
          className="relative z-20 w-full whitespace-nowrap text-3xl text-center uppercase font-bold bg-transparent text-transparent caret-black outline-none"
          onChange={onChange}
          onKeyDown={onKeyDown}
        />
      </div>
